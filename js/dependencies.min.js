...
(function(root) {
    ...
    function factory(angular, Spinner) {
        angular.module("angularSpinner", []).factory("usSpinnerService", [ "$rootScope", function($rootScope) {
            var config = {};
...
(function() {
    "use strict";
    angular.module("wu.masonry", []).controller("MasonryCtrl", [ "$scope", "$element", "$timeout", function controller($scope, $element, $timeout) {
        var bricks = {};
        var schedule = [];
        var destroyed = false;
        var self = this;
